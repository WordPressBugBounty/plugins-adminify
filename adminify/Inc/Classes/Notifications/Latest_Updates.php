		...
		public function notice_content()
		{
			...
			if("dismissed" !== $forever_notice){
				$jltwp_adminify_changelog_message = sprintf(
					...
					// changelogs
					__('<span class="dashicons dashicons-yes"></span> <span class="adminify-changes-list"> <strong>Fixed:</strong> WP Dashboard Notes plugin not create "+ add notes" issue fixed. </span><br>', 'adminify'),
					__('<span class="dashicons dashicons-yes"></span> <span class="adminify-changes-list"> <strong>Fixed:</strong> Folder Module style broken issue fixed. </span><br>', 'adminify'),
					__('<span class="dashicons dashicons-yes"></span> <span class="adminify-changes-list"> <strong>Fixed:</strong> Folder Module second time not loading on the elementor issue fixed. </span><br>', 'adminify'),
				);
