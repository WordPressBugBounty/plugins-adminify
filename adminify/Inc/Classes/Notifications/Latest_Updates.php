		...
		public function notice_content()
		{
			...
			if("dismissed" !== $forever_notice){
				$jltwp_adminify_changelog_message = sprintf(
					...
					// changelogs
					__('<span class="dashicons dashicons-yes"></span> <span class="adminify-changes-list"> <strong>Added:</strong> Media Replace feature added. </span><br>', 'adminify'),
					__('<span class="dashicons dashicons-yes"></span> <span class="adminify-changes-list"> <strong>Fixed:</strong> WP Adminify UI with Fluent Support header style issue fixed. </span><br>', 'adminify'),
					__('<span class="dashicons dashicons-yes"></span> <span class="adminify-changes-list"> <strong>Fixed:</strong> WP Adminify UI with Fluent Cart header style issue fixed. </span><br>', 'adminify'),
					__('<span class="dashicons dashicons-yes"></span> <span class="adminify-changes-list"> <strong>Fixed:</strong> WP Adminify UI with Fluent Affiliate header style issue fixed. </span><br>', 'adminify'),
				);
