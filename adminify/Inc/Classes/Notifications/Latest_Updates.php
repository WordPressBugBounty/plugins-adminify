		...
		public function notice_content()
		{
			...
			if("dismissed" !== $forever_notice){
				$jltwp_adminify_changelog_message = sprintf(
					...
					// changelogs
					__('<span class="dashicons dashicons-yes"></span> <span class="adminify-changes-list"> <strong>Fixed:</strong> Gutenberg block editor some Dark Mode style issue fixed. </span><br>', 'adminify'),
				);
