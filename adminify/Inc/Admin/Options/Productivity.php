		...
		public function productivity_attachment_fields(&$attachment_fields)
		{
			...
			$attachment_fields_data = [
				...
				[
					...
					'text_off'   => __('No', 'adminify'),
					'text_width' => 80,
					'subtitle'   => __('Swap any media file with new one. URL & metadata stay same. All existing links keep working.', 'adminify'),
					'default'    => $this->get_default_field('media_attachments')['media_replace'],
					'dependency' => ['enable_media', '==', 'true', true],
				],
				[
					...
					'min'        => 1,
					'default'    => $this->get_default_field('media_attachments')['media_replace_backup_limit'],
					'dependency' => [
						['enable_media', '==', 'true', true],
						['media_replace', '==', 'true', true],
					],
				],
				[
